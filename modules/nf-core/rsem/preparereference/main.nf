process RSEM_PREPAREREFERENCE {
    ...
    tuple val(meta), path ("rsem/*transcripts.fa"), emit: transcript_fasta
    ...
    if (args_list.contains('--star')) {
        ...
        cp rsem/${meta.id}.transcripts.fa .
    ...
    stub:
    """
    touch rsem/${meta.id}.transcripts.fa
    touch ${meta.id}.transcripts.fa
